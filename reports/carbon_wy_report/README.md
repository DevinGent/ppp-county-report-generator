...
* Outliers (by loan dollars): Provides a more complete set of outliers in which the amount of loan dollars approved in Carbon differed from the rest of the state.
